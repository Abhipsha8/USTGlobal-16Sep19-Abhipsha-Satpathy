...
public class HelloController {
	...
	public String createCookie(ModelMap map,
		...
		Cookie cookie = new Cookie("name","Abhya");
	...
	public String readCookie(ModelMap map,
			@CookieValue(name = "name", required = false) String name) {//spring needs this cookie... this is not present then it will give 400
